...
let result = maxOfTwoNumbers(3, 5);
console.log(result);
...
let findLongest = findLongestWord(words);
...
let avgLenght = averageWordLength(wordsArray);
...
let uniquify = uniquifyArray(wordsUniq);
...
let wordSearch = doesWordExist(wordsFind, search);
